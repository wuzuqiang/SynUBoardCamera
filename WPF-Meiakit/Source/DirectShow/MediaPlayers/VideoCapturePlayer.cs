...
namespace WPFMediaKit.DirectShow.MediaPlayers
{
    ...
    public class VideoCapturePlayer : MediaPlayerBase, ISampleGrabberCB
    {
        ...
        /// <summary>
        /// The list name of the video capture parameter
        /// </summary>
        private List<DeviceParaInfo> m_videoCaptureParam;

        /// <summary>
        /// Flag to detect if the capture source has changed
        /// </summary>
        private bool m_videoCaptureParamChanged;
        ...
        public List<DeviceParaInfo> VideoCaptureParam
        {
            get
            {
                VerifyAccess();
                return m_videoCaptureParam;
            }
            set
            {
                VerifyAccess();
                m_videoCaptureParam = value;
                m_videoCaptureParamChanged = true;
        ...
        private void SetupGraph()
        {
            ...
            try
            {
                ...
                object ampControl;
                int hr11 = graphBuilder.FindInterface(PinCategory.Capture, MediaType.Video, m_captureDevice, typeof(IAMVideoProcAmp).GUID, out ampControl);

                //DsError.ThrowExceptionForHR(hr);
                VideoAProcAmp = ampControl as IAMVideoProcAmp;
        ...
        public IAMVideoProcAmp VideoAProcAmp;
        ...
        public CameraControlSetter CameraControlSetter
        {
            get;set;
        }

        public VideoProcAmpSetter VideoProcAmpSetter
        {
            get;set;
        }
    }
