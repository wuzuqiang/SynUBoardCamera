...
namespace WPFMediaKit.DirectShow.Controls
{
    ...
    public abstract class MediaElementBase : D3DRenderer
    {
        ...
        public bool IsDeviceFault = false;
        public delegate void MediaPlayErrorEventHanlder();
        public event MediaPlayErrorEventHanlder MediaPlayError;
        /// <summary>
        /// Plays the media
        /// </summary>
        public virtual void Play()
        {
            ...
            MediaPlayerBase.Dispatcher.BeginInvoke((Action)(delegate
            {
                MediaPlayerBase.WindowRun += MediaPlayerBase_WindowRun;
        ...
        private void MediaPlayerBase_WindowRun()
        {
            IsDeviceFault = true;
            MediaPlayError();
        }
